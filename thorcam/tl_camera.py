...
def _create_c_failure_message(sdk, function_name, error_code):
    ...
    failure_message = (
        ...
        "error message: {last_error}".format(
            function_name=function_name, error_code=error_code, last_error=last_error
        )
    )
...
class TLCameraSDK(object):
    ...
    def __init__(self):
        ...
        try:
            ...
            self._sdk.tl_camera_get_cooling_enable.argtypes = [
                c_void_p,
                POINTER(c_bool),
            ]
    ...
    def discover_available_cameras(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_discover_available_cameras", error_code
                    )
                )
        ...
        **kwargs,  # type: Optional[Any]
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_set_camera_connect_callback", error_code
                    )
                )
...
class TLCamera(object):
    ...
    def get_pending_frame_or_null(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_pending_frame_or_null", error_code
                    )
                )
            if not image_buffer:
                return None
            ...
            image_buffer_as_np_array = np.ctypeslib.as_array(
                image_buffer,
                shape=(self._local_image_height_pixels, self._local_image_width_pixels),
            )
                ...
                if pixel_clock_high > -1 and pixel_clock_low > -1:
                    ...
                    time_stamp_relative_ns = int(
                        (
                            ...
                            / decimal.Decimal(self._local_timestamp_clock_frequency)
                        )
                        * 1000000000
                    )
    ...
    def get_measured_frame_rate_fps(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_measured_frame_rate", error_code
                    )
                )
    ...
    def get_is_operation_mode_supported(self, operation_mode):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "get_is_operation_mode_supported", error_code
                    )
                )
            return bool(is_supported.value)
        except Exception as exception:
            _logger.error(
                "Could not get if operation mode was supported; " + str(exception)
            )
            raise exception
    ...
    def get_default_white_balance_matrix(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "get_default_white_balance_matrix", error_code
                    )
                )
    ...
    def issue_software_trigger(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_issue_software_trigger", error_code
                    )
                )
        except Exception as exception:
    ...
    def convert_gain_to_decibels(self, gain):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_convert_gain_to_decibels", error_code
                    )
                )
    ...
    def convert_decibels_to_gain(self, gain_db):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_convert_decibels_to_gain", error_code
                    )
                )
            return int(c_gain.value)
        except Exception as exception:
            _logger.error(
                "Could not convert decibel gain to gain index; " + str(exception)
            )
            raise exception
    ...
    def _internal_command(self, command):
        ...
        try:
            ...
            error_code = self._sdk._internal_command(
                self._camera, command_data, len(command) + 1, response_data, _STRING_MAX
            )
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
    ...
    def image_poll_timeout_ms(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_image_poll_timeout", error_code
                    )
                )
    ...
    def image_poll_timeout_ms(self, timeout_ms):
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_set_image_poll_timeout", error_code
                    )
                )
        except Exception as exception:
    ...
    def exposure_time_range_us(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_exposure_time_range", error_code
                    )
                )
            return Range(
                int(exposure_time_us_min.value), int(exposure_time_us_max.value)
            )
        except Exception as exception:
    ...
    def sensor_readout_time_ns(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_sensor_readout_time", error_code
                    )
                )
    ...
    def is_hot_pixel_correction_enabled(self):
        ...
        try:
            ...
            _logger.error(
                "Could not get is hot pixel correction enabled; " + str(exception)
            )
            raise exception
    ...
    def is_hot_pixel_correction_enabled(self, is_hot_pixel_correction_enabled):
        try:
            ...
            _logger.error(
                "Could not set is hot pixel correction enabled; " + str(exception)
            )
            raise exception
    ...
    def hot_pixel_correction_threshold(self):
        ...
        try:
            ...
            _logger.error(
                "Could not get hot pixel correction threshold; " + str(exception)
            )
            raise exception
    ...
    def hot_pixel_correction_threshold(self, hot_pixel_correction_threshold):
        try:
            ...
            _logger.error(
                "Could not set hot pixel correction threshold; " + str(exception)
            )
            raise exception
    ...
    def hot_pixel_correction_threshold_range(self):
        ...
        try:
            ...
            _logger.error(
                "Could not get hot pixel correction threshold range; " + str(exception)
            )
            raise exception
    ...
    def image_width_range_pixels(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_image_width_range", error_code
                    )
                )
            return Range(
                int(image_width_pixels_min.value), int(image_width_pixels_max.value)
            )
        except Exception as exception:
    ...
    def image_height_range_pixels(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_image_height_range", error_code
                    )
                )
            return Range(
                int(image_height_pixels_min.value), int(image_height_pixels_max.value)
            )
        except Exception as exception:
    ...
    def name_string_length_range(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_name_string_length_range", error_code
                    )
                )
            return Range(
                int(name_string_length_min.value), int(name_string_length_max.value)
            )
        except Exception as exception:
    ...
    def frames_per_trigger_range(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_frames_per_trigger_range", error_code
                    )
                )
            return Range(
    ...
    def communication_interface(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_communication_interface", error_code
                    )
                )
    ...
    def is_cooling_supported(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_is_cooling_supported", error_code
                    )
                )
    ...
    def is_cooling_enabled(self):
        ...
        try:
            ...
            error_code = self._sdk.tl_camera_get_cooling_enable(
                self._camera, is_cooling_enabled
            )
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_cooling_enable", error_code
                    )
                )
    ...
    def is_nir_boost_supported(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_is_nir_boost_supported", error_code
                    )
                )
    ...
    def camera_sensor_type(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_camera_sensor_type", error_code
                    )
                )
    ...
    def color_filter_array_phase(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_color_filter_array_phase", error_code
                    )
                )
    ...
    def sensor_pixel_size_bytes(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_sensor_pixel_size_bytes", error_code
                    )
                )
    ...
    def sensor_pixel_width_um(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_sensor_pixel_width", error_code
                    )
                )
    ...
    def sensor_pixel_height_um(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_sensor_pixel_height", error_code
                    )
                )
    ...
    def serial_number_string_length_range(self):
        ...
        try:
            ...
            _logger.error(
                "Could not get serial number string length range; " + str(exception)
            )
            raise exception
    ...
    def black_level_range(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_black_level_range", error_code
                    )
                )
    ...
    def frame_rate_control_value_range(self):
        ...
        try:
            ...
            return Range(
                float(frame_rate_control_min.value), float(frame_rate_control_max.value)
            )
        except Exception as exception:
            _logger.error(
                "Could not get frame rate control value range; " + str(exception)
            )
            raise exception
    ...
    def is_frame_rate_control_enabled(self):
        ...
        try:
            ...
            _logger.error(
                "Could not get is frame rate control enabled; " + str(exception)
            )
            raise exception
    ...
    def is_frame_rate_control_enabled(self, is_frame_rate_control_enabled):
        try:
            ...
            _logger.error(
                "Could not set is frame rate control enabled; " + str(exception)
            )
            raise exception
    ...
    def frame_rate_control_value(self):
        ...
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_get_frame_rate_control_value", error_code
                    )
                )
    ...
    def frame_rate_control_value(self, frame_rate_control_value_fps):
        try:
            ...
            if error_code != 0:
                raise TLCameraError(
                    _create_c_failure_message(
                        self._sdk, "tl_camera_set_frame_rate_control_value", error_code
                    )
                )
        except Exception as exception:
