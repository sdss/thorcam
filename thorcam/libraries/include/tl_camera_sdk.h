...
typedef int (*_INTERNAL_COMMAND)(void *tl_camera_handle, char *data, const size_t command_size_bytes_including_any_null_terminator, char *response, const size_t response_size);
